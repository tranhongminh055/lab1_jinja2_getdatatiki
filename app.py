...
# 4: ĐỊNH NGHĨA HÀM LẤY DỮ LIỆU TỪ LAZADA 
def get_lazada_data():
    # Hàm này có nhiệm vụ lấy dữ liệu sản phẩm từ trang Lazada
    """Lấy dữ liệu sản phẩm từ Lazada bằng Selenium."""
...
def home():
    ...
    try:
        ...
        # Gọi hàm get_lazada_data() để lấy dữ liệu sản phẩm từ Lazada
        products = get_lazada_data()
    except Exception as e:
        # Nếu có lỗi khi gọi get_lazada_data, ghi log lỗi đầy đủ
        logging.exception("Lỗi khi gọi get_lazada_data")
